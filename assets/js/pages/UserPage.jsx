...
const handleSubmit = async event =>{
    ...
    <Select
        ...
        <Field name="adress1" type="text"  placeholder="ex: 1 rue claude debussy" label="Adresse 1 : *" onChange={handleChange}  value={user.adress1} error={errors.adress1}/>
        ...
        <Field name="email" type="text"  placeholder="ex : biprax@biprax.fr" label="Adresse : *" onChange={handleChange}  value={user.email} error={errors.email}/>
